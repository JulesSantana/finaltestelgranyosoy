...
export default function Home() {
  ...
  const olivarCarouselImages = [
    ...
    '/PHOTO-2025-10-14-13-02-51(15) copy.jpg',
    '/PHOTO-2025-10-14-13-02-51(14).jpg',
    '/PHOTO-2025-10-14-13-02-51(13).jpg',
    '/PHOTO-2025-10-14-13-02-51(12).jpg',
              ...
              <div className="rounded-2xl p-10 border-2" style={{ backgroundColor: '#1E4F8F', borderColor: '#1E4F8F40' }}>
                ...
                <div className="mb-8">
                  <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-6">
                    {['/Imagen de WhatsApp 2025-10-26 a las 13.26.36_49918b58.jpg', '/Imagen de WhatsApp 2025-10-26 a las 13.26.35_08374622.jpg', '/Imagen de WhatsApp 2025-10-26 a las 13.26.35_bc961a07.jpg', '/Imagen de WhatsApp 2025-10-26 a las 13.26.35_0c137072.jpg'].map((img, idx) => (
                  ...
                  <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-6">
                    {['/image11.jpeg', '/image12.jpeg', '/image13.jpeg', '/image14.jpeg'].map((img, idx) => (
                      <div key={idx} className="relative aspect-square overflow-hidden rounded-lg shadow-md cursor-pointer hover:shadow-xl transition-shadow" onClick={() => {
                        const modal = document.getElementById('food-image-modal');
                        const modalImg = document.getElementById('food-modal-image') as HTMLImageElement;
                        if (modal && modalImg) {
                  ...
                  <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-8">
                    {['/image1(6).jpeg', '/image2(9)(1).jpeg', '/image0(24).jpeg', '/image6(2).jpeg'].map((img, idx) => (
                      <div key={idx} className="relative aspect-square overflow-hidden rounded-lg shadow-md cursor-pointer hover:shadow-xl transition-shadow" onClick={() => {
                        const modal = document.getElementById('food-image-modal');
                        const modalImg = document.getElementById('food-modal-image') as HTMLImageElement;
                        if (modal && modalImg) {
