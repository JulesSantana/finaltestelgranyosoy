  ...
  return (
    <div className="min-h-screen" style={{ backgroundColor: '#F4D03F' }}>
      <section className="relative overflow-hidden" style={{ backgroundColor: '#F4D03F' }}>
        <div className="container mx-auto px-4 md:px-6 py-6 md:py-8" style={{ backgroundColor: '#F4D03F' }}>
          <div className="bg-white rounded-xl shadow-lg p-4 md:p-6">
            <div className="mb-4 md:mb-6 text-center">
              ...
              `}</style>
              <h1 className="elegant-title text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-bold tracking-tight" style={{
            ...
            <div className="mt-6 md:mt-8 text-center space-y-4 md:space-y-5 px-2">
              <Link href="/suscripciones" className="block">
                <Button
                  size="lg"
                  className="bg-white hover:bg-gray-50 rounded-full w-full max-w-md mx-auto px-8 py-7 md:py-8 text-base md:text-lg font-semibold shadow-xl transition-all min-h-[56px] md:min-h-[64px]"
                  style={{ color: '#1e4f8f' }}
                >
                  MODO DE SUSCRIPCION
                </Button>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 items-stretch max-w-7xl mx-auto">
            ...
            <div className="flex flex-col">
              ...
              <div className="bg-white rounded-xl shadow-lg p-6 md:p-8 flex flex-col h-full">
                <h3 className="text-xl md:text-2xl font-bold mb-4 md:mb-6 text-center cursor-pointer hover:opacity-80 transition-opacity" style={{ color: '#1E4F8F' }} onClick={() => {
                  const modal = document.getElementById('streaming-modal');
                  if (modal) modal.style.display = 'flex';
                }}>Streaming</h3>
                <div className="relative rounded-lg overflow-hidden p-4 md:p-6 overflow-y-auto cursor-pointer hover:opacity-95 transition-opacity flex-grow" style={{ backgroundColor: '#15304a', minHeight: '400px' }} onClick={() => {
                  const modal = document.getElementById('streaming-modal');
                  if (modal) modal.style.display = 'flex';
                }}>
                  <div className="text-left text-white space-y-4">
                    <h2 className="text-base md:text-lg font-bold text-center mb-3" style={{ color: '#F4D03F' }}>
                    ...
                    `}</style>
                    <p className="shining-text text-xs md:text-sm text-center mb-4 font-semibold">
                      Programa: "Celebrando con Jesús" – Sección: "Si me ves, ganas"
                    </p>

                    <div className="space-y-3 text-xs md:text-sm leading-relaxed">
                      <div>
                        <h3 className="font-bold mb-1 text-xs md:text-sm" style={{ color: '#F4D03F' }}>1. Objeto</h3>
                        <p className="text-[11px] md:text-[12px] leading-relaxed">El presente documento establece las normas que regulan la participación de concursantes en la sección "Si me ves, ganas", dentro del formato televisivo "Celebrando con Jesús".</p>
                      </div>

                      <div>
                        <h3 className="font-bold mb-1 text-xs md:text-sm" style={{ color: '#F4D03F' }}>2. Selección de concursantes</h3>
                        <p className="text-[11px] md:text-[12px] leading-relaxed mb-1">2.1. Los concursantes deberán visualizar el streaming "Si me ves, ganas", emitido al finalizar el programa televisivo principal.</p>
                        <p className="text-[11px] md:text-[12px] leading-relaxed mb-1">2.2. Durante la transmisión, se realizará un sorteo ("el bombo") mediante el cual se seleccionará al concursante ganador.</p>
                        <p className="text-[11px] md:text-[12px] leading-relaxed">2.3. El participante seleccionado deberá responder la videollamada. En caso de no contestar, perderá su oportunidad.</p>
                      </div>

                      <div>
                        <h3 className="font-bold mb-1 text-xs md:text-sm" style={{ color: '#F4D03F' }}>3. Obligaciones del concursante</h3>
                        <p className="text-[11px] md:text-[12px] leading-relaxed">3.1. Los concursantes deberán exponer su testimonio personal, compartiendo cómo Dios ha obrado en su vida.</p>
                      </div>

                      <div>
                        <h3 className="font-bold mb-1 text-xs md:text-sm" style={{ color: '#F4D03F' }}>4. Producción del evento</h3>
                        <p className="text-[11px] md:text-[12px] leading-relaxed">El equipo de producción se desplazará hasta el país de residencia del ganador para llevar a cabo el evento.</p>
                      </div>

                      <div className="text-center pt-2">
                        <p className="text-xs md:text-sm italic" style={{ color: '#F4D03F' }}>
            ...
            <div className="flex flex-col items-center justify-center h-full py-8 md:py-0" style={{ minHeight: '400px' }}>
              <div className="relative bg-transparent animate-fade-in-up hover:scale-105 transition-all duration-500 group w-full max-w-xs md:max-w-sm px-4">
                <Image
                  src="/image.png"
                  alt="El Gran Yo Soy"
                  width={400}
                  height={64}
                  className="object-contain w-full h-auto transition-all duration-500 group-hover:drop-shadow-[0_0_20px_rgba(30,79,143,0.6)]"
                  style={{
            ...
            <div className="flex flex-col">
              <div className="text-center mb-6">
                ...
                `}</style>
                <p className="shiny-blue-text-needs text-lg sm:text-xl md:text-2xl font-bold tracking-wide px-2">
              ...
              <div className="bg-white rounded-xl shadow-lg p-6 md:p-8 flex flex-col h-full">
                ...
                <div className="relative rounded-lg overflow-hidden p-4 md:p-6 overflow-y-auto cursor-pointer hover:opacity-95 transition-opacity flex-grow" style={{ backgroundColor: '#15304a', minHeight: '400px' }} onClick={() => {
                  ...
                  <div className="text-left text-white space-y-4">
                    <p className="leading-relaxed text-[11px] md:text-[12px]">
                    ...
                    <p className="italic text-center text-xs md:text-sm" style={{ color: '#F4D03F' }}>
                    ...
                    <div className="space-y-2">
                      <p className="font-bold text-xs md:text-sm" style={{ color: '#F4D03F' }}>Categorías de Ayuda:</p>
                      <p className="text-[11px] md:text-[12px]">1. Salud • 2. Educación • 3. Vivienda</p>
                      <p className="text-[11px] md:text-[12px]">4. Emprendimiento • 5. Emergencias • 6. Otros motivos</p>
                    </div>

                    <div className="flex-grow flex items-center justify-center">
                      <p className="text-xs md:text-sm italic text-center" style={{ color: '#F4D03F' }}>
                        Haz clic para ver las bases completas
                      </p>
                    </div>
                  </div>
      ...
      <section className="py-8 md:py-12" style={{ backgroundColor: '#F4D03F' }}>
        <div className="container mx-auto px-4 md:px-6">
          <div className="max-w-6xl mx-auto">
            <div className="text-center mb-8 md:mb-12">
              <h2 className="text-3xl sm:text-4xl md:text-5xl font-bold mb-3 md:mb-4 px-2" style={{
                color: '#FFFFFF',
                fontFamily: 'system-ui, sans-serif',
              ...
              <p className="text-base md:text-lg mb-2 px-2" style={{ color: '#1E4F8F', fontFamily: 'system-ui, sans-serif' }}>
            ...
            <div className="grid md:grid-cols-2 gap-6 md:gap-8 mb-6 md:mb-8">
              <div className="rounded-2xl p-6 md:p-8 lg:p-10 border-2" style={{ backgroundColor: '#1E4F8F', borderColor: '#1E4F8F40' }}>
                <h2 className="text-xl md:text-2xl font-bold text-center mb-4 md:mb-6" style={{ color: '#F4D03F' }}>
                  Descripción
                </h2>
                <p className="leading-relaxed mb-3 md:mb-4 text-center text-sm md:text-base" style={{ color: '#FFFFFF', fontFamily: 'Georgia, serif', lineHeight: '1.7' }}>
                ...
                <h3 className="text-lg md:text-xl lg:text-2xl font-bold text-center mb-4 md:mb-6 mt-6 md:mt-8" style={{ color: '#F4D03F' }}>
              ...
              <div className="rounded-2xl p-6 md:p-8 lg:p-10 border-2" style={{ backgroundColor: '#1E4F8F', borderColor: '#1E4F8F40' }}>
                ...
                <p className="leading-relaxed mb-4 md:mb-6 text-center text-sm md:text-base" style={{ color: '#FFFFFF', fontFamily: 'Georgia, serif', lineHeight: '1.7' }}>
      ...
      <section className="py-8 md:py-16" style={{ backgroundColor: '#F4D03F' }}>
        <div className="container mx-auto px-4 md:px-6">
          <div className="max-w-4xl mx-auto">
            <div className="rounded-2xl p-6 md:p-10 lg:p-12 shadow-xl" style={{ backgroundColor: '#1E4F8F' }}>
              <h2 className="text-2xl md:text-3xl lg:text-4xl font-heading font-bold mb-6 md:mb-8 text-center" style={{ color: '#F4D03F' }}>
      ...
      <section className="py-12 md:py-20" style={{ backgroundColor: '#F4D03F' }}>
        <div className="container mx-auto px-4 md:px-6">
          <div className="text-center mb-12 md:mb-16">
            <h2 className="text-3xl md:text-4xl lg:text-5xl font-heading font-bold mb-4 px-2" style={{
              color: '#FFFFFF',
              textShadow: '0 0 20px rgba(255, 255, 255, 0.8), 0 0 40px rgba(255, 255, 255, 0.6), 0 0 60px rgba(255, 255, 255, 0.4)'
            }}>
              Colaboradores
          ...
          <div className="text-center mt-12 md:mt-20 mb-12 md:mb-16">
            <h2 className="text-3xl md:text-4xl lg:text-5xl font-heading font-bold mb-4 px-2" style={{
              color: '#FFFFFF',
              textShadow: '0 0 20px rgba(255, 255, 255, 0.8), 0 0 40px rgba(255, 255, 255, 0.6), 0 0 60px rgba(255, 255, 255, 0.4)'
            }}>
      ...
      <section className="py-8 md:py-16" style={{ backgroundColor: '#F4D03F' }}>
        <div className="container mx-auto px-4 md:px-6">
          <div className="max-w-5xl mx-auto">
            <div className="rounded-3xl p-6 md:p-10 lg:p-16 shadow-xl" style={{ backgroundColor: '#1E4F8F' }}>
              <h2 className="text-2xl md:text-3xl lg:text-4xl font-heading font-bold mb-6 md:mb-8 text-center" style={{ color: '#F4D03F' }}>
                Estrategia de Éxito
              </h2>
              <p className="text-base md:text-lg lg:text-xl leading-relaxed mb-4 md:mb-6 text-center" style={{ color: '#FFFFFF' }}>
