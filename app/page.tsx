              ...
              <div className="rounded-2xl p-10 border-2" style={{ backgroundColor: '#1E4F8F', borderColor: '#1E4F8F40' }}>
                ...
                <div className="mb-8">
                  <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-6">
                    {['/Imagen de WhatsApp 2025-10-26 a las 13.26.36_49918b58.jpg', '/Imagen de WhatsApp 2025-10-26 a las 13.26.35_a184b9a4.jpg', '/image3(4).jpeg', '/image4(2).jpeg'].map((img, idx) => (
